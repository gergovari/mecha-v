...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{res/imgs/mecha_26_tractive_element_graph_2.png}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{res/imgs/mecha_26_tractive_element_impedance.png}
\end{figure}

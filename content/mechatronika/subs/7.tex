    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[>=latex]
            \begin{axis}[
                ...
                ytick={1},
                axis line style={->},
                every axis x label/.style={at={(current axis.east)}, anchor=west},
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[>=latex]
            \begin{axis}[
                ...
                % Series of impulses
                % u[i]w[0]
                \addplot[green, dashed, thin, ycomb, mark=o, mark options={solid, black}] coordinates {(1.5, 0.8)};
                \node[right, font=\scriptsize] at (axis cs:1.5, 1.0) {$u[i]w[0]$};
                \draw[gray, thin] (axis cs:1.5, 0.8) -- (axis cs:1.5, 0.95);

                 % u[i]w[1]
                \addplot[green, dashed, thin, ycomb, mark=o, mark options={solid, black}] coordinates {(2.2, 0.7)};
                \node[right, font=\scriptsize] (w1) at (axis cs:2.2, 0.9) {$u[i]w[1]$};
                \draw[gray, thin] (axis cs:2.2, 0.7) -- (axis cs:2.2, 0.85);

                % Dots
                \node at (axis cs:3.0, 0.6) {$\dots$};
                ...
                \node[above, font=\scriptsize] at (axis cs:4.5, 0.35) {$u[i]w[K-i]$};
                 ...
                 % Extra visual elements from source image
                 % Small circles for samples
                 \addplot[green, dashed, thin, ycomb, mark=o, mark options={solid, black}] coordinates {(3.5, 0.5)};

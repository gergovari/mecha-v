\subsection{Mutassa be, milyen módszerekkel határozható meg a kereszt, illetve átmenő változók értékei különféle források figyelembevétele esetén! Ismertesse az egyes módszerek alkalmazásának lépéseit egy példa segítségével!}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_thevenin_norton.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_negligible_parallel.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_negligible_series.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_voltage_divider.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_current_divider.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_nodal_potential.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/mecha_22_mesh_current.png}
\end{figure}

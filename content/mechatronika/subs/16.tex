...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Q -- töltés [C] = [As]
    \end{itemize}
    \item impedanciák ($Z(s) = \frac{\chi(s)}{\phi(s)} = \frac{U(s)}{I(s)}$):
    \begin{itemize}
        \item ellenállás: $Z_R = R$
        \item induktivitás: $Z_L = sL$
        \item kapacitás: $Z_C = \frac{1}{sC}$
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item m -- tömeg [kg]
    \end{itemize}
    \item impedanciák ($Z(s) = \frac{\chi(s)}{\phi(s)} = \frac{v(s)}{f(s)}$):
    \begin{itemize}
        \item csillapítás: $Z_b = \frac{1}{b}$
        \item rugó: $Z_k = \frac{s}{k}$
        \item tömeg: $Z_m = \frac{1}{s m}$
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item impedanciák ($Z(s) = \frac{\chi(s)}{\phi(s)} = \frac{\omega(s)}{M(s)}$):
    \begin{itemize}
        \item csillapítás: $Z_B = \frac{1}{B}$
        \item torziós rugó: $Z_k = \frac{s}{k}$
        \item tehetetlenségi nyomaték: $Z_J = \frac{1}{s J}$
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item impedanciák ($Z(s) = \frac{\chi(s)}{\phi(s)} = \frac{P(s)}{Q_v(s)}$):
    \begin{itemize}
        \item fluid ellenállás: $Z_R = R_f$
        \item fluid kapacitás: $Z_C = \frac{1}{s C_f}$
        \item fluid induktivitás: $Z_L = s L_f$
    \end{itemize}
\end{itemize}

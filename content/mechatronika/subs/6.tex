\subsection{A lineáris időinvariáns (LTI) rendszerek diszkrét idejű állapottér modelljének felhasználásával, előretartó Euler módszer segítésével vezesse le a folytonos idejű lineáris időinvariáns (LTI) rendszerek állapottér modellt!}

\noindent \textbf{Lineáris időinvariáns rendszerek diszkrét idejű állapottér modellje:}
\begin{align*}

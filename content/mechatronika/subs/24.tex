...
% [Diagram: Fogaskerék-hajtómű felépítése]

\begin{itemize}
    \item \textbf{struktúragráf:}
\end{itemize}

% [Diagram: Fogaskerék-hajtómű struktúragráfja]
...
% [Diagram: Fogaskerék geometria]
% [Diagram: Kapcsolódó fogaskerekek sebességvektorai]

\begin{itemize}
    \item ezek lesznek a kapcsolóegyenleteink, így az impedanciahálózat:
\end{itemize}

% [Diagram: Fogaskerék-hajtómű impedanciahálózata]
...
% [Diagram: Fogaskerék-fogasléc felépítése]

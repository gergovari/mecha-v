\subsection{Egy adott, tanult példa (fogaskerékhajtómű, fogaskerék-fogasléc) kapcsán ismertesse a struktúra gráf és az impedancia hálózat felrajzolásának lépéseit. Válaszában térjen ki az egy oldalra redukálás módszerére a rendszerek közötti átjárásokat biztosító fizikai összefüggések alapján!}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{res/imgs/mecha_24_rack_pinion_graph.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{res/imgs/mecha_24_rack_pinion_impedance.png}
\end{figure}

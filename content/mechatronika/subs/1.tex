\subsection{Hasonlítsa össze a vezérlést és a szabályozást: a hatáslánc jellege, zavarjelekkel szembeni ellenállás, a mért mennyiség fajtája, reakció idő, illetve az irányításhoz felhasznált eszközök költsége szerint, valamint szemléltesse a hatásláncokat blokkdiagram segítségével!}
    ...
    \begin{itemize}
        ...
        \item lefutó vezérlés
              \begin{itemize}
                  ...
                  \item feltétel – pl. klíma kikapcsolása nyitott ablaknál, vagy vészleállító
              \end{itemize}
    \end{itemize}
\end{minipage}
\hfill
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{itemize}
        ...
        \item kaszkád – több hurkú szabályozás – pl. szervo hajtás (pozíció, sebesség és áram hurok)

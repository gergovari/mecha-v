...
\textbf{Perceptron:}
\begin{itemize}
    \item \textbf{egyrétegű perceptron}
    \begin{itemize}
    ...
    \end{center}
    \item \textbf{logikai kapuk megvalósítása:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{4. iteráció:} növeljük $p$ értékét eggyel, menjünk vissza a 2-es lépésre, ismételjük addig, amíg nincs konvergencia
    \end{itemize}
\end{itemize}
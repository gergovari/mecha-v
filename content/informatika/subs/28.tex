...
plot(x,y2,'blue');
\end{minted}
    \item függvény automatikus rajzolás
    \begin{itemize}
        \item \verb|fplot()|
    \end{itemize}
    \item kirajzolt ablak skálázása
    \begin{itemize}
        \item \verb|grid();|
    \end{itemize}
    \item címsor
    ...
    \end{itemize}
    \item méretarányos skálaosztás a tengelyeken
    \begin{itemize}
    ...
    \end{itemize}
    \item 3d paraméteresen megadott görbe
    \begin{itemize}
        \item \verb|plot3()|
    \end{itemize}
    \item fájlkezelés:

...
\noindent \textbf{Absztrakció:}
\begin{itemize}
    \item a valós világ egy részének egyszerűsített modellje, csak a lényeges tulajdonságokra koncentrálunk
    \item a bonyolult implementációs részletek elrejtése a felhasználó elől (pl. elég tudni, mit csinál egy metódus, nem kell tudni, hogyan)
\end{itemize}

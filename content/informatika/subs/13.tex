...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{res/imgs/info_13_data_hiding.png}
\end{figure}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{res/imgs/info_13_composition.png}
\end{minipage}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{res/imgs/info_13_aggregation_1.png}
\end{minipage}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{res/imgs/info_13_aggregation_2.png}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{res/imgs/info_13_multiple_inheritance.png}
\end{minipage}
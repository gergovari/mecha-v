\subsection{Fontosabb adatszerkezetek. Tömb, kapcsolt lista, verem, sor, fa, gráf. Pointer fogalma.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{res/imgs/info_4_tree_structure.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{res/imgs/info_4_queue.png}
\end{figure}
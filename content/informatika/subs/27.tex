...
\begin{itemize}
    ...
    \item \textbf{gén:} funkcionális entitás, ez egyed egy speciális tulajdonságát kódolja (pl. hajszín)
    \item \textbf{allél:} a gén értéke (pl. szőke)
    \item \textbf{egyed:} kromoszóma, egy megoldás jelölt a problémára
    \begin{itemize}
        \item a probléma egy lehetséges megoldása valamilyen formában az egyedbe van kódolva (pl. bináris, vagy valós)
        \item \textbf{fitnesz érték:} az egyedeket valamilyen kritérium szerint kiértékeljük, aszerint, hogy milyen jó megoldást adnak a problémára
        \item jobb egyedeknek nagyobb a fitnesz értéke, nagyobb eséllyel élnek túl
    \end{itemize}
    \item \textbf{genotípus:} egy egyed alléljainak egy speciális kombinációja
    \item \textbf{fenotípus:} egy egyed külső-belső tulajdonságainak összessége
    \item \textbf{locus:} egy gén pozíciója a kromoszómán belül
    \item \textbf{populáció:} egyszerre együtt élő egyedek összessége
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \begin{minipage}[t]{0.5\textwidth} rulett kerék szelekció: az egyedek a fitnesz értékükkel arányos nagyságú szeletet kapnak \end{minipage} \begin{minipage}[t]{0.4\textwidth} \vspace{-15pt} \begin{center} \includegraphics[width=\textwidth]{res/imgs/info_27_roulette_selection.png} \end{center} \end{minipage}
    \end{itemize}
    \vspace{10pt}
    \item \textbf{keresztezés:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \end{center}
    \item \textbf{véletlenszerű programok létrehozása:}
    \begin{itemize}
        \item \textbf{rendelkezésre álló függvények:} pl. $F = \{+, -, *, /, IF\}$
        \item \textbf{rendelkezésre álló terminálisok:} pl. $T = \{X, Y, \text{konstansok}\}$
        \item \textbf{véletlen programok:}
        \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{genetikus operátorok:}
    \begin{itemize}
        \item \textbf{reprodukció:}
        \begin{itemize}

...
\textbf{3D görbék:}
\begin{itemize}
    \item \textbf{függvényközelítés:} $y = f(x)$, $z = g(x)$
    \item \textbf{implicit görbemegadás:} $f(x,y,z) = 0$
\end{itemize}
...
\begin{minipage}{0.7\textwidth}
    \begin{equation*}
        \begin{split}
            \underline{Q}(t) = \underline{P_1} * s_{P1}(t) + \underline{P_4} * s_{P4}(t) \\
            + \underline{R_1} * s_{R1}(t) + \underline{R_4} * s_{R4}(t) \quad t \in [0,1]
        \end{split}
    \end{equation*}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{f: kardinális paraméter} -- mennyire sima/szögletes a görbe
\end{itemize}

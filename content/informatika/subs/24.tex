...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{medián (rank) szűrés} (nem lineáris)
        \begin{itemize}
...
\begin{itemize}
    \item \textbf{életlenség eltávolítása}
    \begin{itemize}
        \item éles kép = 1,5 * kép - 0,5 * blur(kép)
    \end{itemize}
    \item \textbf{bilaterális szűrés}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    \item \textbf{élkeresés Canny módszerével}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{szegmentálás felülről lefelé (Top-down):} közös ismert objektum hasonló pixeleinek keresése
    \item \textbf{szegmentálás lentről felfelé (Bottom-up):} azonos jellegű pixelek gyűjtése pixelből indítva
\end{itemize}
\begin{center}
...
\begin{itemize}
    \item \textbf{globális szegmentálás küszöbértékekkel}
    \begin{itemize}
        \item Top-down
    ...
    \item \textbf{Isodata algoritmus} – Iterativ Self-Organizing Data Analysis Technique
    \begin{itemize}
        \item Top-down
    \end{itemize}
    \begin{center}
...
\begin{itemize}
    \item \textbf{adaptív szegmentálás küszöbértékekkel}
    \begin{itemize}
        \item átlaggal vág
    \end{itemize}
    \item \textbf{elárasztás statisztikával}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{elárasztás vágóélekkel}
\end{itemize}

\textbf{Alakfelismerés:}
\begin{itemize}
    \item \textbf{alakfelismerés sablonillesztéssel}
    \begin{equation*}
    ...
    \end{center}
    \item \textbf{alakfelismerés Hough transzformációval}
    \begin{itemize}
        \item \textbf{egyenesek:}
        \begin{center}
